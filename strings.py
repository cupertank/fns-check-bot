...
class Strings:
    ...
    К сожалению, сервера ФНС ограничивает количество запросов в день на номер телефона. ✋
    ...
    Пожалуйста, введи свой номер телефона 📞, чтобы авторизироваться в ФНС и начать работу с ботом:
    """)
    ...
    ConnectionToFNSLost = "💥 Потеряно соединение с ФНС. Пожалуйста, попробуй ещё раз."
